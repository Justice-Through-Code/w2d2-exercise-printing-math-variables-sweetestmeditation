def convert_100_to_celsius():
    ...
    print('int' if celsius_100.is_integer() else 'float')
    ...
    # Comment
    """
    This formula, (Fahrenheit - 32) * 5/9 , is used to convert from Fahrenheit to Celsius.
    I utilize the is_integer() method, which returns True if the number is an integer, 
    to detect whether it's an integer or float.
    """
...
def hotter_temp():
    ...
    if (celsius_temp * 9/5) + 32 > fahrenheit_temp:
